...
int showMountPoints(std::string address, uint16_t port, std::string username, std::string password)
{
...
int main(int argc, const char* argv[])
{
	...
	if (yesno.compare("yes") == 0 || yesno.compare("y") == 0) {
		return showMountPoints(address, (uint16_t)port, username, password);
	}
